...
【字数硬性要求 — 这是本批最重要的标准】
每条脚本5-6个镜头，每个镜头口播30-40字，全条合计必须达到150字以上（上限200字）。
· 5个镜头 × 每镜头30字 = 150字（最低合格线）
· 6个镜头 × 每镜头35字 = 210字（略微删减即可）
· 禁止每个镜头只写一两句话就结束，口播要说完整、说清楚。
...
[
  {{
    ...
    "title": "标题",
    "shots": [
      {{"scene": "主理人站在工作室，拿起一件产品", "dialogue": "（这里写30-40字的口播，要有具体细节和情绪，不能只写一句话就停）"}},
      {{"scene": "场景描述10-20字", "dialogue": "（30-40字口播）"}},
      {{"scene": "场景描述10-20字", "dialogue": "（30-40字口播）"}},
      {{"scene": "场景描述10-20字", "dialogue": "（30-40字口播）"}},
      {{"scene": "场景描述10-20字", "dialogue": "（30-40字口播，结尾按类型处理）"}}
    ],
